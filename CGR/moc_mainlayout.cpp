...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MainLayout_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 53, 9)
    },
    "MainLayout\0toCamera\0\0toGallery\0toResult\0"
    "i\0j\0fileName\0takeShoot\0"
};
...
void MainLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->toCamera(); break;
        case 1: _t->toGallery(); break;
        case 2: _t->toResult(); break;
        case 3: _t->toResult((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->toResult((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 5: _t->takeShoot(); break;
        default: ;
        }
    }
}
...
const QMetaObject MainLayout::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MainLayout.data,
      qt_meta_data_MainLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainLayout.stringdata))
